...
let package = Package(
    ...
    dependencies: [
        ...
        .package(name: "CapacitorSpotifyAuth", path: "../../../node_modules/.pnpm/capacitor-spotify-auth@1.0.1_@capacitor+core@8.3.1/node_modules/capacitor-spotify-auth")
    ],
    targets: [
        .target(
            name: "CapApp-SPM",
            dependencies: [
                ...
                .product(name: "CapacitorSpotifyAuth", package: "CapacitorSpotifyAuth")
            ]
        )
    ]
)
