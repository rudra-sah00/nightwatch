    ...
    >
      ...
      <div className="flex flex-wrap justify-center gap-6">
        ...
        <Button
          ...
          variant="neo-base"
          size="none"
          className="group p-3 bg-background border-[3px] border-border hover:bg-neo-red hover:text-primary-foreground"
        >
          <a
        ...
        <Button
          ...
          variant="neo-base"
          size="none"
          className="group p-3 bg-background border-[3px] border-border hover:bg-neo-blue hover:text-primary-foreground"
        >
          <a
        ...
        <Button
          ...
          variant="neo-base"
          size="none"
          className="group p-3 bg-background border-[3px] border-border hover:bg-primary hover:text-primary-foreground"
        >
          <a
