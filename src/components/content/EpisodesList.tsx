  ...
  return (
    ...
    >
      ...
      <div className="flex-shrink-0 w-8 pt-1">
        <span className="text-2xl font-light text-zinc-400">{episode.episode_number}</span>
      </div>
      ...
      <div className="flex-1 min-w-0 pt-1">
        <div className="flex items-start justify-between gap-4 mb-2">
          ...
          {episode.duration && (
            <span className="text-zinc-400 text-sm flex-shrink-0">{episode.duration}m</span>
          )}
        </div>
