...
import type { ContentType, VideoMetadata, ShowDetails } from '@/types/content';
...
export default function MetadataSection({
    ...
    const displayGenre = showDetails?.genre || imdbData?.genre?.join(', ') || videoData?.metadata.genre?.join(', ') || 'Drama, Thriller';
    ...
    return (
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="space-y-3 text-sm">
                ...
                <p className="text-zinc-400">
                    <span className="text-zinc-500">This {actualType === 'Series' ? 'series' : 'movie'} is: </span>
