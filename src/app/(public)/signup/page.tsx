  ...
  return (
    ...
    >
      <main className="flex-grow flex flex-col items-center p-1 md:p-2 justify-center overflow-hidden w-full max-w-[1400px] mx-auto">
        ...
        <div className="mb-0 md:mb-1 text-center hidden md:block mt-8 md:mt-0">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-2 lg:gap-4 w-full max-w-5xl items-center pb-8 md:pb-0 shrink-0">
          ...
          <div className="lg:col-span-5 flex items-center justify-center w-full">
            <div className="bg-white border-4 border-[#1a1a1a] neo-shadow p-4 sm:p-5 flex flex-col gap-3 w-full max-w-md lg:max-w-none h-[640px]">
