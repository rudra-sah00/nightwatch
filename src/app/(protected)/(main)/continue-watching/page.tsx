...
export default function ContinueWatchingPage() {
  ...
  return (
    <main className="min-h-[calc(100vh-80px)] bg-[#f5f0e8] pb-32 animate-in fade-in">
      {/* Hero Header */}
      <div className="border-b-[4px] border-[#1a1a1a] mb-12 bg-[#0055ff] relative overflow-hidden">
