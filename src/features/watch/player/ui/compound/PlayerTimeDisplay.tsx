...
export function PlayerTimeDisplay() {
  ...
  return (
    <div className="px-3 py-1.5 text-white text-xs md:text-sm lg:text-base 2xl:text-lg font-black font-headline uppercase tracking-widest ml-2 md:ml-3 lg:ml-4 2xl:ml-5 tabular-nums flex-shrink-0">
