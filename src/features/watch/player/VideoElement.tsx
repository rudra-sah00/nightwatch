...
export const VideoElement = memo(forwardRef<HTMLVideoElement, VideoElementProps>(
    function VideoElement({ dispatch, onTimeUpdate, onDurationChange, onClick }, ref) {
        ...
        useEffect(() => {
            ...
            const handleProgress = () => {
                if (video.buffered.length > 0) {
                    dispatch({ type: 'SET_BUFFERED', buffered: video.buffered.end(video.buffered.length - 1) });
                }
            };
