...
export function WatchPartyLoading({
  ...
  return (
    <div
      ...
      aria-label={message}
    >
      <div className="bg-[#ffcc00] border-[4px] border-border  px-8 py-6 md:px-12 md:py-8 flex flex-col items-center gap-6 saturate-[1.2] motion-safe:animate-in motion-safe:fade-in motion-safe:zoom-in-95 motion-safe:duration-500 motion-reduce:animate-none">
