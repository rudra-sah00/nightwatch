...
export function WatchPartyLoading({
  ...
  return (
    <div
      className={cn(
        'min-h-screen bg-background flex flex-col items-center justify-center p-6 transition-all duration-500 ease-in-out',
        className,
      )}
    >
      <div className="bg-[#ffcc00] border-[4px] border-border  px-8 py-6 md:px-12 md:py-8 flex flex-col items-center gap-6 saturate-[1.2] animate-in fade-in zoom-in-95 duration-500">
