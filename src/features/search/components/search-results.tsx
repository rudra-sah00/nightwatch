...
function SearchResultItem({ result, onSelect }: SearchResultItemProps) {
    ...
    return (
        <div
            ...
            className="group flex items-center gap-4 p-3 rounded-xl bg-card/40 hover:bg-card/80 border border-border/30 hover:border-border/60 cursor-pointer transition-all duration-200 hover:shadow-lg"
        >
            {/* Landscape Thumbnail */}
