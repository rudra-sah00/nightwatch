...
## [3.0.0](https://github.com/rudra-sah00/nightwatch/compare/v2.16.0...v3.0.0) (2026-09-24)


### ⚠ BREAKING CHANGES

* **home:** remove the Explore feed and its preference toggle
* **auth:** `/login` and `/signup` are gone. Both signing in and creating an account now happen on `/continue`.
...
* add DASH playback support for 1080p streaming ([bafc958](https://github.com/rudra-sah00/nightwatch/commit/bafc9586166601e76509b0e4525ec6262e5fa542))
...
* **android:** stream VOD direct from the CDN via a loopback forwarder ([2d1b8a0](https://github.com/rudra-sah00/nightwatch/commit/2d1b8a0642c6a32f219fe51198021e79b3202fbf))
* **ask-ai:** conversation history, barge-in, and an AudioWorklet pipeline ([2007a8b](https://github.com/rudra-sah00/nightwatch/commit/2007a8b96dd3bc2304919b43ed46d4856f813db5))
* **auth:** native Google signup + open registration ([fe27015](https://github.com/rudra-sah00/nightwatch/commit/fe270151c1a7797076a66932c94089d25fbfccc8))
* **auth:** one "Continue with Google" route replacing login and signup ([76ec1fa](https://github.com/rudra-sah00/nightwatch/commit/76ec1fa59813ff5ff84691962f946b65c98ce115))
* **auth:** open signup + Google OAuth registration ([c3d3d06](https://github.com/rudra-sah00/nightwatch/commit/c3d3d06bcc9988cadde735a33213c20738538407))
* **auth:** route Google sign-in and sign-up to each other automatically ([7508c81](https://github.com/rudra-sah00/nightwatch/commit/7508c81c809ab1ec293c62331766135ffbcaf7fe))
...
* **home:** remove the Explore feed and its preference toggle ([b046b91](https://github.com/rudra-sah00/nightwatch/commit/b046b91cb07bda386749cbb3812cccca4385839b))
* **home:** replace the landing page with an entry hub ([9e1cd31](https://github.com/rudra-sah00/nightwatch/commit/9e1cd31fff3cedbf94f5e04f6bb170a3d11ecde2))
* **hub:** gate every authenticated route behind the hub on each load ([c7e3326](https://github.com/rudra-sah00/nightwatch/commit/c7e3326bec7ffed97b8067b4384da861b6d286ff))
...
* **music:** hold the floating disc to close the player ([c2e197a](https://github.com/rudra-sah00/nightwatch/commit/c2e197a7fa43d8382682795c772d2ee531bd5ace))
...
* **player:** hold Space or long-press to play at 2x, YouTube-style ([62d369c](https://github.com/rudra-sah00/nightwatch/commit/62d369c3f9c37e9567c60c1bec9148efcbc523ab))
...
* **search:** badge each result poster with the catalogue it came from ([6ada8c4](https://github.com/rudra-sah00/nightwatch/commit/6ada8c47b9cb783c433076afcd9e3e5181786877))
...
* shuffle games order on every page load ([1460d05](https://github.com/rudra-sah00/nightwatch/commit/1460d055a1a202f3384143a17adc4aef9c62d487))
...
* **theatre:** Enter to type, the way a game does it ([f8dd04c](https://github.com/rudra-sah00/nightwatch/commit/f8dd04c69c7d149a599631b04ae81b0a13030036))
* **theatre:** give the cafe real surface finishes and something to reflect ([b2d9fef](https://github.com/rudra-sah00/nightwatch/commit/b2d9feffc4061c6edb7d57ca509c340fcf07d3f8))
* **theatre:** hold-D dance wheel, gated on real free space ([ff2643f](https://github.com/rudra-sah00/nightwatch/commit/ff2643ff278d58f56f04bc146993731f63e48140))
* **theatre:** live FPS and network readout in the 3D view ([656cc2c](https://github.com/rudra-sah00/nightwatch/commit/656cc2cef869dfe1600dc525c92911e8d6aa0746))
* **theatre:** persistent download toast with progress and retry ([3a5dde6](https://github.com/rudra-sah00/nightwatch/commit/3a5dde6c8b685b5e3dd2bbf02aa65eebd0793f8b))
* **theatre:** play the party video on the in-scene screen, add E to sit ([2d7dd9b](https://github.com/rudra-sah00/nightwatch/commit/2d7dd9bcb1f254da1ca36744cc32de5d6fe5a26b))
* **theatre:** real round-trip ping, and move the HUD to bottom right ([721a8fa](https://github.com/rudra-sah00/nightwatch/commit/721a8fa68655ab646127484e265f89d23e3dddd4))
* **theatre:** sit and dance animation, name labels, speech bubbles ([ff86038](https://github.com/rudra-sah00/nightwatch/commit/ff860386385a21717da3f5cdb9a693aca49e5bf8))
* **theatre:** widen the auditorium to ten seats, five a row ([db58a34](https://github.com/rudra-sah00/nightwatch/commit/db58a34085f117b7dff90ddd0c8d20c434d40cca))
* **theatre:** wider seats, uncut screen, dance camera, cafe doors ([0cd8a52](https://github.com/rudra-sah00/nightwatch/commit/0cd8a52d003e9f325f03f648a15637ab612fc924))
* **theatre:** write the controls down in the room ([208df28](https://github.com/rudra-sah00/nightwatch/commit/208df287e00ac9dd758322f4e74d422b79ae1844))
...
* **watch-party:** 3D theatre mode with physics-based walking ([e1b6317](https://github.com/rudra-sah00/nightwatch/commit/e1b6317cbaa309bdbb20fab814c4156c17fa76a5))
...
* **watch-party:** move signalling to our own relay, remove Agora RTM ([b1e35ee](https://github.com/rudra-sah00/nightwatch/commit/b1e35eeb584fecc1453f3931a8d268b015c6d4b4))
* **watch:** play VOD direct from CDN on desktop, prompt for the app on web ([876a7a9](https://github.com/rudra-sah00/nightwatch/commit/876a7a9b292ff93879e9a0ed118ea1d406b92886))
...
* **android:** unblock loopback media playback (CSP + mixed content), return 502 ([b28d422](https://github.com/rudra-sah00/nightwatch/commit/b28d422ee527728b792cce31af8ec5caa92a353f))
...
* **ask-ai:** end session after playback, fix duplicate lines, pause music ([38e1f0f](https://github.com/rudra-sah00/nightwatch/commit/38e1f0f9eac59598cd07a7793383b8587327a5d4))
...
* **auth:** guard protected routes server-side with proxy.ts ([8e75a9d](https://github.com/rudra-sah00/nightwatch/commit/8e75a9df86c9fd7e8a8db2a702b61032e32b9205))
* **auth:** keep Back and the submit button inside the signup card ([bd36429](https://github.com/rudra-sah00/nightwatch/commit/bd3642944da3ab95d7ba108ce940b1463f929d28))
...
* **auth:** show a sign-out confirmation instead of "session expired" ([b604fba](https://github.com/rudra-sah00/nightwatch/commit/b604fba276a38e6fe57a36cc1f22e312b6d75b71))
...
* **ci:** unbreak Vercel deploys after @vercel/next enabled its Next adapter ([768b71b](https://github.com/rudra-sah00/nightwatch/commit/768b71b137708383ebc86e9ec4dc47f905534996))
...
* **csp:** allow blob: in connect-src for hls.js and Agora workers ([ab7b773](https://github.com/rudra-sah00/nightwatch/commit/ab7b773bb1481800df1079f8b7f7b1a92ce3339d))
...
* **deps:** scope the postcss override so the lockfile can match ([7d952c7](https://github.com/rudra-sah00/nightwatch/commit/7d952c7571aa6149dd1f3be5ccb3f644524292aa))
...
* **notifications:** add a suggestions toggle, drop four dead ones ([99cfbf8](https://github.com/rudra-sah00/nightwatch/commit/99cfbf8f46bc3149f6e7900bacd962445bc09d9e))
...
* **player:** cap fatal media-error recovery and report what actually failed ([e77cdfa](https://github.com/rudra-sah00/nightwatch/commit/e77cdfade67f362ab6f0971098abc208c5300d2a))
...
* **player:** close the VOD seek gap and bump hls.js to 1.7.3 ([b29c47e](https://github.com/rudra-sah00/nightwatch/commit/b29c47e43539587557545dfbc9db96c9eff3b3f0))
...
* **player:** re-prime the decoder on seek so VOD seeking works at all ([efcb498](https://github.com/rudra-sah00/nightwatch/commit/efcb498dda6b45f108acb5cd9069b3fc925f33cd))
* **player:** reload instead of rebuilding when the platform decoder cannot re-init ([b74a1a9](https://github.com/rudra-sah00/nightwatch/commit/b74a1a9a8cf5e867367716b07cf0e3d822a16e0c))
...
* **player:** stop showing mobile controls on touch-capable laptops ([359217c](https://github.com/rudra-sah00/nightwatch/commit/359217c09331dcddcdabe9aa7f5018842dae0057))
...
* **profile:** restore the Explore on Home toggle ([dac7351](https://github.com/rudra-sah00/nightwatch/commit/dac735159f690d632b078b462b0da94d69f0e0b2))
...
* **search:** give /search a landing state when there is no query ([ee122d4](https://github.com/rudra-sah00/nightwatch/commit/ee122d4596e765bfbb7713411a2bfe4fb6dca1db))
* **search:** restore the marquee strip on the landing ([153c697](https://github.com/rudra-sah00/nightwatch/commit/153c697e96e60e995d74dd72c89d94a80150ff6b))
...
* signup one field per step, restore dead patches, clear all advisories ([239b32e](https://github.com/rudra-sah00/nightwatch/commit/239b32ebd370976d8ec5d3eb9392110fecc05858))
...
* **sketch:** stop Next.js barrel-optimising konva, which silently disabled drawing ([b90099c](https://github.com/rudra-sah00/nightwatch/commit/b90099c6ad5083ada22741860e45752ec3e6581a))
...
* **smart-tv:** pin spatial-navigation react so D-pad focus works ([325503e](https://github.com/rudra-sah00/nightwatch/commit/325503ee166ab13846ab5d61f89f007a6e323b0b))
* **smart-tv:** stop the TV skeleton flashing on web routes ([bc96cde](https://github.com/rudra-sah00/nightwatch/commit/bc96cdef1e70f105b45c4693e32198e851340b58))
...
* **sw:** skip service worker in dev and clear its stale caches ([4735035](https://github.com/rudra-sah00/nightwatch/commit/473503570974231f9b675d66c276a56fd8b1667e))
...
* **theatre:** advance the frame loop in seconds, not milliseconds ([6a39c72](https://github.com/rudra-sah00/nightwatch/commit/6a39c72c785633ab1611c62379eca9d09a0ee1ad))
* **theatre:** character identity, spawn stacking and late-joiner seat desync ([75e274c](https://github.com/rudra-sah00/nightwatch/commit/75e274c624b2a24eea61c7c7162020c2494c77b4))
* **theatre:** despawn avatars on leave, and label them from the roster ([950424b](https://github.com/rudra-sah00/nightwatch/commit/950424bf9011f581037b53947795fb0bb250782c))
* **theatre:** keep your seat and your place in the room across a 2D switch ([45a4f32](https://github.com/rudra-sah00/nightwatch/commit/45a4f32c4d3442dc0c3ae19f44af9090dffe979e))
* **theatre:** light the room, dim on sitting, and show the film ([055538c](https://github.com/rudra-sah00/nightwatch/commit/055538c3197d8de54c08134443beae5611858c86))
* **theatre:** light the room, plant avatars on the floor, add mouse look ([1c82d15](https://github.com/rudra-sah00/nightwatch/commit/1c82d1515e5921850f5c684b21fbf1ad171e7d4d))
* **theatre:** mount the cafe and light it, instead of a dark empty room ([9ac7de1](https://github.com/rudra-sah00/nightwatch/commit/9ac7de147cbe6b01e73e217b91f341e5bf5c8117))
* **theatre:** move dance to R, keep chat usable, stop the screen flickering ([de01093](https://github.com/rudra-sah00/nightwatch/commit/de0109312ae2fc79fc704ad8f6ca0efc57ace42f))
* **theatre:** offer the two clips the wheel was hiding ([d710be2](https://github.com/rudra-sah00/nightwatch/commit/d710be2ade92fe1d6e26cde0250956ee1035c763))
* **theatre:** only fetch the asset manifest once 3D is opted into ([fa71f72](https://github.com/rudra-sah00/nightwatch/commit/fa71f720a6b08a32f29eeeae07b1783b1dc2a199))
* **theatre:** only unlock 3D once every asset has actually downloaded ([6444cd7](https://github.com/rudra-sah00/nightwatch/commit/6444cd7995788997419e03b143ca803198d342bb))
* **theatre:** remove avatars and release seats when someone disconnects ([14eaae7](https://github.com/rudra-sah00/nightwatch/commit/14eaae7a2b390baae9fa203e7c4685985851a3eb))
* **theatre:** spawn avatars from membership, not from movement traffic ([60ffad6](https://github.com/rudra-sah00/nightwatch/commit/60ffad67f55abf77bb8fb3ad0368e1d6b75973ba))
* **theatre:** stop the aisle stair colliders running backwards ([33e0aca](https://github.com/rudra-sah00/nightwatch/commit/33e0acabf390222d5c6ca0c93b90775f206dc0f7))
* **theatre:** stop the dance clearance probe crashing the watch party ([8d0b44b](https://github.com/rudra-sah00/nightwatch/commit/8d0b44bc2a3aaf34835fba5b10dafae78cce6a29))
* **theatre:** sync the dance, seat people in their chairs, show 2D members ([267335e](https://github.com/rudra-sah00/nightwatch/commit/267335ec5b7375e553232635d5f1f67ce7197cc5))
* **tour:** rebuild the product tour around the entry hub ([76eef7d](https://github.com/rudra-sah00/nightwatch/commit/76eef7d37e890986d62fac859c2d5a1883f7cdbc))
...
* **watch-party:** announce a departure instead of waiting for Agora to notice ([d174348](https://github.com/rudra-sah00/nightwatch/commit/d174348b72609acac9ea58f700b508f8d318d24c))
* **watch-party:** clear the pending leave timer when the duration check tears down ([02cf692](https://github.com/rudra-sah00/nightwatch/commit/02cf692438cf7a82be3005b6009f7a239178e25a))
* **watch-party:** dispatch each RTM interaction once, not twice ([f4146df](https://github.com/rudra-sah00/nightwatch/commit/f4146df690fc30e7c3252045d40fcacdeec53e75))
* **watch-party:** enforce interaction permissions and handle server party closure ([70a5282](https://github.com/rudra-sah00/nightwatch/commit/70a528205ab4bca4f9496d42d2fa99efb34315f0))
* **watch-party:** expire each laser on its own timer, and scope undo to its author ([f880c0c](https://github.com/rudra-sah00/nightwatch/commit/f880c0cc08c5ed08d436ca0814dbe77e93274771))
* **watch-party:** keep livestream URLs out of stream-token injection ([adbc65a](https://github.com/rudra-sah00/nightwatch/commit/adbc65aa16991e733f5dbbf4f4c7eef51987446e))
* **watch-party:** let a live-TV guest actually start playing ([8d02afb](https://github.com/rudra-sah00/nightwatch/commit/8d02afb05781c3273409e8e7e478fd9732b24cf3))
* **watch-party:** make sidebar content visible in light theme ([d71fcdf](https://github.com/rudra-sah00/nightwatch/commit/d71fcdf5cf46ebed2d8ad288de6d7c6c2d01f87d))
* **watch-party:** make the multi-tab claim protocol block the right tab and recover ([ad18a7d](https://github.com/rudra-sah00/nightwatch/commit/ad18a7d2f73f748e284bebb5762ce70e57b4f145))
* **watch-party:** page chat history on a message id, not a stale count ([a9225c4](https://github.com/rudra-sah00/nightwatch/commit/a9225c4de2c59070e935e6277906503931069bc9))
* **watch-party:** quote the real 3D download size in settings ([46f85be](https://github.com/rudra-sah00/nightwatch/commit/46f85be1ffb85a4b0638fe15ebd771f11031cb48))
...
* **watch-party:** repair sketch drawing — stale stage size, self-refiring undo/clear ([9ac7fff](https://github.com/rudra-sah00/nightwatch/commit/9ac7fff4d4af2a533c26891d10c6211dd796fce2))
...
* **watch-party:** resolve draw permission from the shared resolver, and three smaller corrections ([16c4328](https://github.com/rudra-sah00/nightwatch/commit/16c432886c1bd8bf1be08087c0f93df4fa69bc18))
...
* **watch-party:** stop host broadcasting currentTime 0 on guest join ([31486ff](https://github.com/rudra-sah00/nightwatch/commit/31486ffe40bde9368a21ed720b26fc339748a3ea))
* **watch-party:** trap focus in the leave and settings dialogs ([b3eaf70](https://github.com/rudra-sah00/nightwatch/commit/b3eaf705d62a2b12e3ba2460768986bce14d04d2))
* **watch:** bound levelParsingError retries instead of looping forever ([45e971a](https://github.com/rudra-sah00/nightwatch/commit/45e971a0072aac536e5681ca95740ad9e78a86b0))
...
* **player:** only re-prime seeks where needed, and right-size the VOD buffer ([060620d](https://github.com/rudra-sah00/nightwatch/commit/060620d1101ce86fadea647c658eeaca1381cbfe))
* **theatre:** bound adaptive dpr by the measured ceiling, drop MSAA on Retina ([3872391](https://github.com/rudra-sah00/nightwatch/commit/387239162d78de2d743b7bc0b90c236b42a76574))
* **theatre:** cap the render loop at 60 fps ([c722911](https://github.com/rudra-sah00/nightwatch/commit/c7229117fbb07602d4f6f833ba1e40938d9f20bc))
* **theatre:** dispose cloned avatar materials, stop allocating per frame ([62d071d](https://github.com/rudra-sah00/nightwatch/commit/62d071dbed63fe7ecbfbfc3cc29c615c89563363))
* **theatre:** drop shadows and the ping traffic, hand the readout to drei ([302434f](https://github.com/rudra-sah00/nightwatch/commit/302434fefdeca80a8bcd6ec40b8a7cf2140dd881))
* **theatre:** read KTX2 textures and cap dpr at 1.5 ([f385515](https://github.com/rudra-sah00/nightwatch/commit/f385515258600526dc87b6f6a9bb380c10ef720c))
* **theatre:** retire the cove uplights, keep the band as emissive geometry ([23d56a7](https://github.com/rudra-sah00/nightwatch/commit/23d56a7033897cdc413917d698c1dcfa5c0c21b9))
* **theatre:** uncap the render loop, drop the FPS panel ([b61a4d5](https://github.com/rudra-sah00/nightwatch/commit/b61a4d555b668df47afb2387b1f1153a95735d33))
