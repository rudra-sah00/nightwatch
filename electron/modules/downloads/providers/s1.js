...
async function downloadS1(eventSender, args) {
  ...
  // Process ONLY thumbnails for S1
  if (
    showData &&
    ...
    try {
      ...
      // S1 has no video trailer, remove url so UI doesn't try to play it
      trailer.url = '';
      ...
      console.error('[downloadS1] Error processing thumbnail:', err.message);
    }
